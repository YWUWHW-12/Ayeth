...
╰────────────────┈⊷\n\n🔢 *Please reply with the number of your choice*\n\n`;
        ...
        const sentMsg = await conn.sendMessage(from, {
            image: { url: videos[0].image || 'https://i.ibb.co/zwhqLSQ/20250406-120212.jpg' },
            caption: listText,
            contextInfo: {
                forwardingScore: 999,
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterName: 'HASHI-MD',
...
> *ᴘᴏᴡᴇʀᴅ ʙʏ  ᴋᴀᴠɪᴅᴜ ʀᴀꜱᴀɴɢᴀ : )*`;
                ...
                const handleDownloadOption = async (optionUpdate) => {
                    ...
                    if (isReplyToOptMsg) {
                        ...
                        const caption = `🔞 *KAVI-MD XVIDEO DOWNLOADER* 🔞\n\n📽️ *Title*: ${xv_info.result.title}\n> *ᴘᴏᴡᴇʀᴅ ʙʏ  ᴋᴀᴠɪᴅᴜ ʀᴀꜱᴀɴɢᴀ : )*`;
                            ...
                            await conn.sendMessage(from, {
                                ...
                                contextInfo: {
                                    externalAdReply: {
                                        ...
                                        body: "HASHI-MD XVideo",
                                        mediaType: 2,
                                        sourceUrl: selectedVideo.url,
                                        thumbnailUrl: xv_info.result.image || "https://i.ibb.co/zwhqLSQ/20250406-120212.jpg",
